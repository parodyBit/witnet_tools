...
from witnet.util.socket_manager import SocketManager


class NodeClient(object):
    _instance = None

    def __init__(self, ipv4='127.0.0.1', port=21338):
    ...
    @staticmethod
    def manager(ipv4='127.0.0.1', port=21338):
        # get the singleton instance
        return NodeClient._instance if NodeClient._instance is not None else NodeClient(ipv4=ipv4, port=port)
